...
export default function AttributionOverridesPage() {
  ...
  return (
    <div style={styles.page}>
      ...
      {/* Title */}
      <div style={styles.title}>Attribution Overrides</div>

      {/* Info Banner */}
      <div style={styles.infoBanner}>
        <div style={styles.infoBannerLeft}>
          <div style={styles.fileIcon}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--osmos-brand-primary)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div style={styles.infoBannerText}>
            <span style={styles.fileName}>seller_attribution_overrides.xlsx</span>
